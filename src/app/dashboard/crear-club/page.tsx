...
export default function CrearClubPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) return;
    if (!isSuperAdmin) {
      toast.error('No tienes permisos para crear clubes');
      return;
    }
        ...
        {!authLoading && user && !isSuperAdmin ? (
          <div className="card p-8">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Solo un SuperAdmin puede crear clubes. Pide a un SuperAdmin que cree el club y asigne los roles correspondientes.
            </p>
