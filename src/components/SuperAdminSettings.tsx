...
import { Users, UserPlus, Trash2, Shield, Edit2, Building2, Search, X, Save, Plus } from 'lucide-react';
...
export default function SuperAdminSettings() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'users' | 'clubs'>('users');
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900">Panel SuperAdmin</h3>
            <p className="text-sm text-gray-500">Gestiona clubs, usuarios y permisos</p>
          </div>
        </div>
        
        <div className="flex items-center gap-3">
          <Link href="/dashboard/crear-club" className="btn-primary text-sm flex items-center gap-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar..."
              className="input-field pl-9 pr-9 w-48"
            />
            {searchTerm && (
              <button
